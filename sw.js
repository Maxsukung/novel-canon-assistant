const CACHE='novel-studio-v43-auto-update';
const CORE=['./','./index.html','./styles.css?v=43','./app.js?v=43','./manifest.webmanifest','./icon-192.png','./icon-512.png','./mammoth.browser.min.js','./pdf.legacy.min.mjs','./pdf.legacy.worker.min.mjs'];
